    ...
    public static class SeedExtension
    {
        public static IHost Seed(this IHost host)
        {
            using (var scope = host.Services.CreateScope())
            {
                ...
                var exports = exportRepository.GetAll();
                if (exports.Count == 0)
                {
                    ...
                    exportRepository.SaveNew(exp1);
                    exportRepository.SaveNew(exp2);
                    exportRepository.SaveNew(exp3);
                    exportRepository.SaveNew(exp4);
                }
            }
            return host;
        }
